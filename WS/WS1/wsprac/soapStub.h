...
{
public:
	double *res;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:double */
};
#endif
...
SOAP_FMAC5 int SOAP_FMAC6 ns__add(struct soap*, double a, double b, double *res);
