...
SOAP_FMAC5 int SOAP_FMAC6 ns__add(struct soap*, int a, int b, double *result);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__add(struct soap *soap, const char *soap_endpoint, const char *soap_action, int a, int b, double *result);
