...
{   public:
	...
	calc()
	{ soap = soap_new(); endpoint = "http://www.mysite.com/calc.cgi"; if (soap && !soap->namespaces) { static const struct Namespace namespaces[] = 
{
	...
	virtual int ns__add(int a, int b, double *result) { return soap ? soap_call_ns__add(soap, endpoint, NULL, a, b, result) : SOAP_EOM; };
};
#endif
